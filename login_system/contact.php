...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $existsSql = "SELECT * FROM `shoplogin` WHERE username =  '$username'";
   ...
   if ($numExitsRows > 0) {
      ...
      if (($password == $confirmpassword)) {
         $sql = "INSERT INTO `shoplogin` (`username`, `password`,`dt`) VALUES ('$username', '$password',current_timestamp())";
...
<body>
   ...
   <div class="container">
      ...
      <strong>Success</strong>Restaurant Account created !!
      ...
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
         ...
         ?> </div>
      <h1 class="col-md-6">Sign up to Your Restaurant</h1>
      <form action="/restro/login_system/contact.php" method="post">
