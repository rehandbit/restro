...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $sql = "Select * from shoplogin where username='$username' and password='$password' ";
   ...
   <div class="partition" style="
    ...
    height: 600px;">
      <div class="container my-2">
         <h1 class="col-md-6">Login to Your Restaurant</h1>
         <form action="/restro/login_system/about.php" method="post">
